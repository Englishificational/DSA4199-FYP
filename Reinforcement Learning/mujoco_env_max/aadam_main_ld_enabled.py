                        ...
                        for t_train in range(number_of_train_steps):
                            ...
                            for k in range(kt):
                                ...
                                if fixed_c != None:
                                    ...
                                    adversary_loss_max = max(adversary_loss_max, curr_adversary_loss)
                                if random.random() > 0.9999:
                                    print("adversary_loss_max: ", adversary_loss_max)
                                    print("curr_adversary_loss: ", curr_adversary_loss)
                                ...
                                curr_adversary_loss = adversary_loss
                            train_steps += 1
