...
optimizers = ['RMSprop__no_noise', 'ExtraAdam__action_noise_0.01', 'SGLD_thermal_0.0001__action_noise_0.01']
action_noises = [False, True, True]
...
"""
env_name = "Swimmer-v4"
optimizers = ['RMSprop/action_noise_0.4', 'ExtraAdam/action_noise_0.4', 'SGLD_thermal_1e-05/action_noise_0.4']
action_noises = [True, True, True]
...
"""
env_name = "Ant-v4"
optimizers = ['RMSprop/action_noise_0.4', 'ExtraAdam/action_noise_0.01', 'SGLD_thermal_0.0001/action_noise_0.2']
action_noises = [True, True, True]
