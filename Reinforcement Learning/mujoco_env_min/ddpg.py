...
class DDPG:
    ...
    def update_robust_non_flip(self, state_batch, action_batch, reward_batch, mask_batch, next_state_batch,
                      mdp_type, robust_update_type, policy_loss_min=0):
        ...
        #print("adversary loss 1:", adversary_loss)
        ...
        # vvvvvv this is to get back the baseline, NEED TO REMOVE IF NOT DOING BASELINE
        # removed 
        #c_difference = 0
        if c_difference:
